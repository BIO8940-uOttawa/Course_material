...
```{css, echo=FALSE}
.title-slide {
  background-image: url(assets/img_l2/rmarkdown.png);
}
```
...
knitr::opts_chunk$set(purl = FALSE, fig.path = 'assets/chunks/', cache.path = "assets/cache/", dpi = 300)
library(tidyverse)
...
.center[![](assets/img_l2/phd031214s.png)]

---
# How can you reproduce results?

.center[![](assets/img_l2/ctrlcctrlv.png)]
...
.center[![](assets/img_l2/rmarkdown_workflow.png)]



---
# Structure of a R Markdown document
.center[![](assets/img_l2/rmd_struc.png)
...
.center[![](assets/img_l2/3components.png)]

---

.center[![](assets/img_l2/3componentson.png)]
...
---
# Structure of a R Markdown document
.center[![](assets/img_l2/rmd_struc_markdown.png)]
...
.center[![](assets/img_l2/headers.png)]
...
.center[![](assets/img_l2/lists.png)]
...
.center[![](assets/img_l2/eqns.png)]

---
# Equation blocks

.center[![](assets/img_l2/eqns2.png)]
...
.center[![](assets/img_l2/images.png)]
...
.center[![](assets/img_l2/refguide.png)]
...
---
# Structure of a R Markdown document
.center[![](assets/img_l2/rmd_struc_chunks.png)]
...
.center[![](assets/img_l2/embed.png)]
...
.center[![](assets/img_l2/inline.png)]
...
.center[![](assets/img_l2/chunk_options.png)]
...
.center[![](assets/img_l2/echo2.png)]
...
.center[![](assets/img_l2/figheightfigwidth.png)]
...
.center[![](assets/img_l2/message.png)]
...
.center[![](assets/img_l2/knitr.png)]
...
---
# Structure of a R Markdown document
.center[![](assets/img_l2/rmd_struc_yaml.png)]
...
.center[![](assets/img_l2/yaml.png)]

---
# Knit

.center[![](assets/img_l2/knit_rstudio.png)]
...
.center[![](assets/img_l2/output_formats.png)]
...
.center[![](assets/img_l2/notebook.png)]


---
# Console

.center[![](assets/img_l2/console.png)]
...
.center[![](assets/img_l2/pandoc.png)]



---

.center[![](assets/img_l2/sorcerers.jpg)]
...
.center[![](assets/img_l2/repro_rmarkdown.jpg)]
...
### Credit: I borrowed slides from [Garrett Grolemund](https://rstudio.com/speakers/garrett-grolemund/), [Ulrik Lyngs](https://ulriklyngs.com/), Olivier Gimenez (https://oliviergimenez.github.io) . I also used the beautiful illustrations shared by [Allison Horst](https://github.com/allisonhorst/stats-illustrations).


|                                                                                                            |                                   |
| :--------------------------------------------------------------------------------------------------------- | :-------------------------------- |
| `r icons::fontawesome("envelope", style = "solid")` | **Julien.martin@uottawa.ca**       |
| `r icons::fontawesome("home", style = "solid")` | [**https://juliengamartin.github.io/**](https://juliengamartin.github.io/) |
| `r icons::fontawesome("twitter", style = "brands")` | [**@JGAMartin**](https://twitter.com/JGAMartin)                         |
| `r icons::fontawesome("github", style = "brands")` | [**@JulienGAMartin**](https://github.com/juliengamartin)
